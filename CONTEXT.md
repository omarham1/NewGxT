...
The middle 50% of the Previous Day's wick-to-wick range — from 25% to 75% between PDL and PDH. Distinct from PD 50% Midpoint, which gates Session POI candidacy and directional-bias invalidation.
...
**Active DOL**:
TP1 is the nearest unmitigated HTF swing, PDH/PDL, or PWH/PWL in bias direction, or Daily Open on reversal days. TP2 is the furthest eligible level within the ADR band. HTF FVGs are not Active DOL candidates. Separate from Session POI.
