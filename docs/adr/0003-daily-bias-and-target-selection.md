...
2. **Intraday Bias Shifts and Validation**:
   - **Reversal Confirmation**: Reversal bias is confirmed only when price interacts with a Relevant Level or POI and confirms a full **2-Stage SMT/SS** per [ADR-0005](0005-2-stage-smt-and-strength-switch.md) (Stage 1 HTF/ITF SMT + Stage 2 ITF second SMT **or** SS PSP). LTF [C2](../../CONTEXT.md) / [C3](../../CONTEXT.md) / [CISD](../../CONTEXT.md) is the entry trigger after Stage 2 — not Stage 2 itself. A simple LTF C2/C3 without Stage 2 is not sufficient on its own.
