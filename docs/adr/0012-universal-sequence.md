...
2. **Confirm a swing formation** — Validate with [C2](../../CONTEXT.md) closure, [C3](../../CONTEXT.md) closure, or C2 reversal-to-expansion per ADR-0001. On a full reversal day this is typically [2-Stage SMT](../../CONTEXT.md) or [2-Stage PSP](../../CONTEXT.md) (ADR-0005); Universal Sequence itself does not redefine that gate.
...
**One-stage at the continuation gap:** Once the reversal (or prior expansion) already printed SMT / 2-Stage SMT or 2-Stage PSP confirmation, the continuation gap requires only one-stage SMT Fill (or PSP) — a second 2-stage sequence is not required at that gap.
