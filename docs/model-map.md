...
|---|---|---|---|
| **2-Stage SMT or 2-Stage PSP** | Reversal confirmation | Price at a Relevant Level / POI; need a tradable reversal | ADR-0005, ADR-0003, CONTEXT **2-Stage SMT**, **2-Stage PSP** |
...
1. **2-Stage SMT or 2-Stage PSP** confirms the reversal (or you use the aggressive fallback without full 2-stage).
...
- **4H Profiling** does not replace 2-Stage SMT or 2-Stage PSP or Universal Sequence.
- **2-Stage SMT / 2-Stage PSP** do not own Catch-Up / Continuation — those are Universal Sequence (ADR-0012) via ADR-0002.
