...
- **Level Snapshot** — session context plus unmitigated HTF FVGs and visible HTF swing points
...
// { pdh, pdl, pwh, pwl, dailyOpen, adr, openPlusAdr, openMinusAdr, adrConsumptionPct, pdMidpoint }
...
// SessionContext + { htfFvgs, htfSwingPoints }

const fvgs = computeHtfFvgs({ bars4h, bars1h, bars90m, bars30m, bars15m, mitigationBars, asOf: latestBarTime });
